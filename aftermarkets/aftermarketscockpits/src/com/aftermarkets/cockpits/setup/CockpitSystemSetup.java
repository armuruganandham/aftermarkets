 ...
 */
package com.aftermarkets.cockpits.setup;
...
import com.aftermarkets.cockpits.constants.AftermarketsCockpitsConstants;
 ...
 */
@SystemSetup(extension = AftermarketsCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AftermarketsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AftermarketsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AftermarketsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/aftermarketscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}

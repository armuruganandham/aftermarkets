...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/aftermarketsstorefront/electronics/en",
						"https://electronics.local:9002/aftermarketsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/aftermarketsstorefront/electronics/en",
						"https://electronics.local:9002/aftermarketsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/aftermarketsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/aftermarketsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/aftermarketsstorefront/electronics/en",
						"https://electronics.local:9002/aftermarketsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/aftermarketsstorefront",
						"https://electronics.local:9002/aftermarketsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/aftermarketsstorefront",
						"https://electronics.local:9002/aftermarketsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/aftermarketsstorefront/electronics/en",
						"https://electronics.local:9002/aftermarketsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

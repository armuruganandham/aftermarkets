 ...
 */
package com.aftermarkets.test.setup;
...
import com.aftermarkets.test.constants.AftermarketsTestConstants;
import com.aftermarkets.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AftermarketsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/aftermarketstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/aftermarketstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/aftermarketstest/import/cstickets.impex");
			...
			importImpexFile(context, "/aftermarketstest/import/csquotes.impex");
		}
	}
}

 ...
 */
package com.aftermarkets.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AftermarketsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AftermarketsFulfilmentProcessConstants.PARENT_PROCESS);
